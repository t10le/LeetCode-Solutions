...
| # | Title | Solution | Time | Space | Difficulty | Note
|---| ---| ---| ---| ---| ---| ---|
| 717 | <a href="https://leetcode.com/problems/1-bit-and-2-bit-characters/">1-bit and 2-bit Characters</a> | <a href="https://github.com/t10le/LeetCode-Solutions/blob/main/Python/OneBitTwoBitCharacters.py">Python</a> | O(n) |  | Easyy | |
